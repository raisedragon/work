 ...
 *         &lt;element name="IncludeDestinationCountry" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlType(name = "", propOrder = {
    "mailingAgentID",
    "locationID",
    "includeDestinationCountry",
    "startDate",
    "stopDate",
    "reportID",
    "accessToken"
})
@XmlRootElement(name = "GenerateVolumePostageReport")
public class GenerateVolumePostageReport {

    @XmlElement(name = "MailingAgentID")
    protected String mailingAgentID;
    @XmlElement(name = "LocationID")
    protected String locationID;
    @XmlElement(name = "IncludeDestinationCountry")
    protected int includeDestinationCountry;
    ...
    /**
     * ��ȡincludeDestinationCountry���Ե�ֵ��
     * 
     */
    ...
    /**
     * ����includeDestinationCountry���Ե�ֵ��
     * 
     */
    public void setIncludeDestinationCountry(int value) {
        this.includeDestinationCountry = value;
    }
