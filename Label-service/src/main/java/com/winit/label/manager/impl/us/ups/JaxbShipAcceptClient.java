...
//			System.out.println("Request: " + strWriter.getBuffer().toString());
	...
	public  String contactService(String xmlInputString) throws Exception{
		...
		try {
			...
			URL url = new URL(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_LABLE_API_ENDPOINT_URL")+ConfigUtil.getValue(Constants.SYSCONFIG,"WT_LABLE_API_ENDPOINT_URL_ACCEPT_PATH"));
