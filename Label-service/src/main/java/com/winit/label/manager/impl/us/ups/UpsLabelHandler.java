...
public class UpsLabelHandler implements LabelHandler
{
	...
	private  void populateShipConfirmRequest(ShipmentConfirmRequest shipRequest,RequestMessage requestMsg,DeliveryWay dw)
	{
		...
		transactionReference.setCustomerContext(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_CUSTOMERCONTEXT"));
		...
		shipper.setName(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_NAME").toString()+documentNo);
		shipper.setShipperNumber(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_SHIPPERNUMBER"));
//		shipper.setPhoneNumber(MSysConfig.getValue("WT_UPS_PHONENUMBER"));
		shipper.setAttentionName(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_ATTENTIONNAME").toString()+documentNo);
		
		ShipperAddressType shipperAddress = new ShipperAddressType();
		shipperAddress.setAddressLine1(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_ADDRESSLINE1"));
		shipperAddress.setAddressLine2(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_ADDRESSLINE2"));
		shipperAddress.setAddressLine3(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_ADDRESSLINE3"));
		shipperAddress.setCity(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_CITY"));
		shipperAddress.setPostalCode(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_POSTALCODE"));
		shipperAddress.setStateProvinceCode(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_PROVINCECODE"));
		shipperAddress.setCountryCode(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_COUNTRYCODE"));
...
//		}
		...
		billShipper.setAccountNumber(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_UPS_SHIPPERNUMBER"));
	...
	private String contactService(String xmlInputString) throws Exception
	{
		...
		try
		{
			...
			URL url = new URL(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_LABLE_API_ENDPOINT_URL").toString()+ConfigUtil.getValue(Constants.SYSCONFIG,"WT_LABLE_API_ENDPOINT_URL_CONFIRM_PATH"));
	...
	{
		accessRequest.setAccessLicenseNumber(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_LABLE_API_LICENSE_NUMBER"));
		accessRequest.setUserId(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_LABLE_API_USER_NAME"));
		accessRequest.setPassword(ConfigUtil.getValue(Constants.SYSCONFIG,"WT_LABLE_API_PASSWORD"));
	}
