...
public class VerifyGXGPackageToDestinationLocationResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.VerifyGXGPackageToDestinationLocationResponseVerifyGXGPackageToDestinationLocationResult verifyGXGPackageToDestinationLocationResult;

    public VerifyGXGPackageToDestinationLocationResponse() {
    }

    public VerifyGXGPackageToDestinationLocationResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.VerifyGXGPackageToDestinationLocationResponseVerifyGXGPackageToDestinationLocationResult verifyGXGPackageToDestinationLocationResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.VerifyGXGPackageToDestinationLocationResponseVerifyGXGPackageToDestinationLocationResult getVerifyGXGPackageToDestinationLocationResult() {
        return verifyGXGPackageToDestinationLocationResult;
    }
     ...
     */
    public void setVerifyGXGPackageToDestinationLocationResult(com.winit.svr.label.handler.impl.usa.usps.model.VerifyGXGPackageToDestinationLocationResponseVerifyGXGPackageToDestinationLocationResult verifyGXGPackageToDestinationLocationResult) {
        this.verifyGXGPackageToDestinationLocationResult = verifyGXGPackageToDestinationLocationResult;
    }
