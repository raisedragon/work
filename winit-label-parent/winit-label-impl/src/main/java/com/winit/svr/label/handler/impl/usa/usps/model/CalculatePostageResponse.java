...
public class CalculatePostageResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.CalculatePostageResult calculatePostageResult;

    public CalculatePostageResponse() {
    }

    public CalculatePostageResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.CalculatePostageResult calculatePostageResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.CalculatePostageResult getCalculatePostageResult() {
        return calculatePostageResult;
    }
     ...
     */
    public void setCalculatePostageResult(com.winit.svr.label.handler.impl.usa.usps.model.CalculatePostageResult calculatePostageResult) {
        this.calculatePostageResult = calculatePostageResult;
    }
