...
public class TrackPackageResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.TrackResult trackPackageResult;

    public TrackPackageResponse() {
    }

    public TrackPackageResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.TrackResult trackPackageResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.TrackResult getTrackPackageResult() {
        return trackPackageResult;
    }
     ...
     */
    public void setTrackPackageResult(com.winit.svr.label.handler.impl.usa.usps.model.TrackResult trackPackageResult) {
        this.trackPackageResult = trackPackageResult;
    }
