...
public class SearchForProcessedPackageResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.SearchForProcessedPackageResponseSearchForProcessedPackageResult searchForProcessedPackageResult;

    public SearchForProcessedPackageResponse() {
    }

    public SearchForProcessedPackageResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.SearchForProcessedPackageResponseSearchForProcessedPackageResult searchForProcessedPackageResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.SearchForProcessedPackageResponseSearchForProcessedPackageResult getSearchForProcessedPackageResult() {
        return searchForProcessedPackageResult;
    }
     ...
     */
    public void setSearchForProcessedPackageResult(com.winit.svr.label.handler.impl.usa.usps.model.SearchForProcessedPackageResponseSearchForProcessedPackageResult searchForProcessedPackageResult) {
        this.searchForProcessedPackageResult = searchForProcessedPackageResult;
    }
