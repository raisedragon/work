...
import com.winit.svr.label.RequestMessage.ClassifyProduct;
...
public class USPSIntlShipLabelImpl implements LabelHandler
{

	Logger logger = LoggerFactory.getLogger(USPSIntlShipLabelImpl.class);
	...
	{
		return this.handle(commandContext, requestMessage);
	}
