...
public class GetDestinationLocationsResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.DestinationLocationsResult getDestinationLocationsResult;

    public GetDestinationLocationsResponse() {
    }

    public GetDestinationLocationsResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.DestinationLocationsResult getDestinationLocationsResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.DestinationLocationsResult getGetDestinationLocationsResult() {
        return getDestinationLocationsResult;
    }
     ...
     */
    public void setGetDestinationLocationsResult(com.winit.svr.label.handler.impl.usa.usps.model.DestinationLocationsResult getDestinationLocationsResult) {
        this.getDestinationLocationsResult = getDestinationLocationsResult;
    }
