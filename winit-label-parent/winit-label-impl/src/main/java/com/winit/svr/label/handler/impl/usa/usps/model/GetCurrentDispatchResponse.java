...
public class GetCurrentDispatchResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.GetCurrentDispatchResponseGetCurrentDispatchResult getCurrentDispatchResult;

    public GetCurrentDispatchResponse() {
    }

    public GetCurrentDispatchResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.GetCurrentDispatchResponseGetCurrentDispatchResult getCurrentDispatchResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.GetCurrentDispatchResponseGetCurrentDispatchResult getGetCurrentDispatchResult() {
        return getCurrentDispatchResult;
    }
     ...
     */
    public void setGetCurrentDispatchResult(com.winit.svr.label.handler.impl.usa.usps.model.GetCurrentDispatchResponseGetCurrentDispatchResult getCurrentDispatchResult) {
        this.getCurrentDispatchResult = getCurrentDispatchResult;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.usps-cpas.com/usps-cpas/GSSAPI/", ">>GetCurrentDispatchResponse>GetCurrentDispatchResult"));
