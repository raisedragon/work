...
public class TrackPackageWithPostalCodeResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.TrackingWithPostalCodeResult trackPackageWithPostalCodeResult;

    public TrackPackageWithPostalCodeResponse() {
    }

    public TrackPackageWithPostalCodeResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.TrackingWithPostalCodeResult trackPackageWithPostalCodeResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.TrackingWithPostalCodeResult getTrackPackageWithPostalCodeResult() {
        return trackPackageWithPostalCodeResult;
    }
     ...
     */
    public void setTrackPackageWithPostalCodeResult(com.winit.svr.label.handler.impl.usa.usps.model.TrackingWithPostalCodeResult trackPackageWithPostalCodeResult) {
        this.trackPackageWithPostalCodeResult = trackPackageWithPostalCodeResult;
    }
