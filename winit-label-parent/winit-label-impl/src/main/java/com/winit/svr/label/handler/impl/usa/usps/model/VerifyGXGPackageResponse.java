...
public class VerifyGXGPackageResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.VerifyGXGPackageResponseVerifyGXGPackageResult verifyGXGPackageResult;

    public VerifyGXGPackageResponse() {
    }

    public VerifyGXGPackageResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.VerifyGXGPackageResponseVerifyGXGPackageResult verifyGXGPackageResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.VerifyGXGPackageResponseVerifyGXGPackageResult getVerifyGXGPackageResult() {
        return verifyGXGPackageResult;
    }
     ...
     */
    public void setVerifyGXGPackageResult(com.winit.svr.label.handler.impl.usa.usps.model.VerifyGXGPackageResponseVerifyGXGPackageResult verifyGXGPackageResult) {
        this.verifyGXGPackageResult = verifyGXGPackageResult;
    }
