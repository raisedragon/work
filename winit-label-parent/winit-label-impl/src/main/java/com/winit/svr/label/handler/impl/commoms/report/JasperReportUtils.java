package com.winit.svr.label.handler.impl.commoms.report;
...
public class JasperReportUtils
{
	...
	private static final String BASE_JASPER_PATH = "jasper/template";
    ...
    public static String generateImageAsBase64(String reportFile, Map param) throws Exception {
			...
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperData.getJasperReport(), param);
