...
public class CloseDispatchResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.CloseDispatchResult closeDispatchResult;

    public CloseDispatchResponse() {
    }

    public CloseDispatchResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.CloseDispatchResult closeDispatchResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.CloseDispatchResult getCloseDispatchResult() {
        return closeDispatchResult;
    }
     ...
     */
    public void setCloseDispatchResult(com.winit.svr.label.handler.impl.usa.usps.model.CloseDispatchResult closeDispatchResult) {
        this.closeDispatchResult = closeDispatchResult;
    }
