...
public class CloseReceptacleResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.CommonResult closeReceptacleResult;

    public CloseReceptacleResponse() {
    }

    public CloseReceptacleResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.CommonResult closeReceptacleResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.CommonResult getCloseReceptacleResult() {
        return closeReceptacleResult;
    }
     ...
     */
    public void setCloseReceptacleResult(com.winit.svr.label.handler.impl.usa.usps.model.CommonResult closeReceptacleResult) {
        this.closeReceptacleResult = closeReceptacleResult;
    }
