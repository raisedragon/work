...
public class GenerateActivityReportResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.GenerateReportResult generateActivityReportResult;

    public GenerateActivityReportResponse() {
    }

    public GenerateActivityReportResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.GenerateReportResult generateActivityReportResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.GenerateReportResult getGenerateActivityReportResult() {
        return generateActivityReportResult;
    }
     ...
     */
    public void setGenerateActivityReportResult(com.winit.svr.label.handler.impl.usa.usps.model.GenerateReportResult generateActivityReportResult) {
        this.generateActivityReportResult = generateActivityReportResult;
    }
