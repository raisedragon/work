package com.winit.svr.label.handler.impl.commons.report;
...
public class JasperReportUtils
{
	...
	private static String BASE_JASPER_PATH = "jasper/template";

	private static JasperPrint jasperPrint;

    static {
    	//TODO
    	BASE_JASPER_PATH="E:/GitRepo/work/winit-label-parent/winit-label-impl/src/main/resources/jasper/template";
    	REPORT_HOME = new File(BASE_JASPER_PATH);
//    	Resource springResource = new ClassPathResource(BASE_JASPER_PATH);
//		try
//		{
//			REPORT_HOME =  springResource.getFile();
//			System.out.println(REPORT_HOME.getAbsolutePath());
//		}
//		catch (IOException e)
//		{
