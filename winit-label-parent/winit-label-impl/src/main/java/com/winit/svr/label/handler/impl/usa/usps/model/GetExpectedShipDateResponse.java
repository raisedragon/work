...
public class GetExpectedShipDateResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.ExpectedShipResult getExpectedShipDateResult;

    public GetExpectedShipDateResponse() {
    }

    public GetExpectedShipDateResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.ExpectedShipResult getExpectedShipDateResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.ExpectedShipResult getGetExpectedShipDateResult() {
        return getExpectedShipDateResult;
    }
     ...
     */
    public void setGetExpectedShipDateResult(com.winit.svr.label.handler.impl.usa.usps.model.ExpectedShipResult getExpectedShipDateResult) {
        this.getExpectedShipDateResult = getExpectedShipDateResult;
    }
