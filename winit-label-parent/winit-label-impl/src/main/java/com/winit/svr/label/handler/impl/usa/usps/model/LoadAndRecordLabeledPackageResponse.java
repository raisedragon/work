...
public class LoadAndRecordLabeledPackageResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult loadAndRecordLabeledPackageResult;

    public LoadAndRecordLabeledPackageResponse() {
    }

    public LoadAndRecordLabeledPackageResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult loadAndRecordLabeledPackageResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult getLoadAndRecordLabeledPackageResult() {
        return loadAndRecordLabeledPackageResult;
    }
     ...
     */
    public void setLoadAndRecordLabeledPackageResult(com.winit.svr.label.handler.impl.usa.usps.model.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult loadAndRecordLabeledPackageResult) {
        this.loadAndRecordLabeledPackageResult = loadAndRecordLabeledPackageResult;
    }
