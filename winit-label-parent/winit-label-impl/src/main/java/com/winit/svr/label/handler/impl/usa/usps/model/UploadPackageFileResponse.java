...
public class UploadPackageFileResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.CommonResult uploadPackageFileResult;

    public UploadPackageFileResponse() {
    }

    public UploadPackageFileResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.CommonResult uploadPackageFileResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.CommonResult getUploadPackageFileResult() {
        return uploadPackageFileResult;
    }
     ...
     */
    public void setUploadPackageFileResult(com.winit.svr.label.handler.impl.usa.usps.model.CommonResult uploadPackageFileResult) {
        this.uploadPackageFileResult = uploadPackageFileResult;
    }
