...
public class GetAvailableReportsForDispatchResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.GetAvailableReportResult getAvailableReportsForDispatchResult;

    public GetAvailableReportsForDispatchResponse() {
    }

    public GetAvailableReportsForDispatchResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.GetAvailableReportResult getAvailableReportsForDispatchResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.GetAvailableReportResult getGetAvailableReportsForDispatchResult() {
        return getAvailableReportsForDispatchResult;
    }
     ...
     */
    public void setGetAvailableReportsForDispatchResult(com.winit.svr.label.handler.impl.usa.usps.model.GetAvailableReportResult getAvailableReportsForDispatchResult) {
        this.getAvailableReportsForDispatchResult = getAvailableReportsForDispatchResult;
    }
