...
public class GetRequiredReportsForDispatchResponse  implements java.io.Serializable {
    private com.winit.svr.label.handler.impl.usa.usps.model.GetAvailableReportResult getRequiredReportsForDispatchResult;

    public GetRequiredReportsForDispatchResponse() {
    }

    public GetRequiredReportsForDispatchResponse(
           com.winit.svr.label.handler.impl.usa.usps.model.GetAvailableReportResult getRequiredReportsForDispatchResult) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.GetAvailableReportResult getGetRequiredReportsForDispatchResult() {
        return getRequiredReportsForDispatchResult;
    }
     ...
     */
    public void setGetRequiredReportsForDispatchResult(com.winit.svr.label.handler.impl.usa.usps.model.GetAvailableReportResult getRequiredReportsForDispatchResult) {
        this.getRequiredReportsForDispatchResult = getRequiredReportsForDispatchResult;
    }
