...
public class TrackResult  implements java.io.Serializable {
    ...
    private com.winit.svr.label.handler.impl.usa.usps.model.TrackingEvent[] trackingEvent;
    ...
    public TrackResult(
           ...
           com.winit.svr.label.handler.impl.usa.usps.model.TrackingEvent[] trackingEvent) {
     ...
     */
    public com.winit.svr.label.handler.impl.usa.usps.model.TrackingEvent[] getTrackingEvent() {
        return trackingEvent;
    }
     ...
     * @param trackingEvent
     */
    public void setTrackingEvent(com.winit.svr.label.handler.impl.usa.usps.model.TrackingEvent[] trackingEvent) {
        this.trackingEvent = trackingEvent;
    }
