 ...
 *
 */
public class LogisticTypeEnitityManager extends AbstractManager {
  ...
  public LogisticTypeQuery createNewLogisticTypeQuery() {
    return new LogisticTypeQueryImpl(Context.getLabelServerConfiguration().getCommandExecutor());
  }
  
  public LogisticTypeEntity findByLogisticTypeId(String logisticTypeId) {
	  return (LogisticTypeEntity) getDbSqlSession().selectOne("selectLogisticTypeById", logisticTypeId);
  }
  
  public LogisticTypeEntity findByLogisticTypeCode(String logisticTypeCode) {
	  return (LogisticTypeEntity) getDbSqlSession().selectOne("selectLogisticTypeByCode", logisticTypeCode);
  }
