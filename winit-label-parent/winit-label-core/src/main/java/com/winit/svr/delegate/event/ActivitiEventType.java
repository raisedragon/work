 ...
 */
package com.winit.svr.delegate.event;
...
public enum ActivitiEventType {
   ...
   * @throws LabelIllegalArgumentException when one of the given string is not a valid type name
   */
  public static ActivitiEventType[] getTypesFromString(String string) {
    ...
    if(string != null && !string.isEmpty()) {
      ...
      for(String typeName : split) {
        ...
        if(!found) {
          throw new LabelIllegalArgumentException("Invalid event-type: " + typeName);
        }
      }
    }
