 ...
 */
package com.winit.svr.impl.util;
...
import com.winit.svr.ActivitiClassLoadingException;
...
public abstract class ReflectUtil {
  ...
  public static Object instantiate(String className) {
    try {
      ...
      throw new LabelException("couldn't instantiate class "+className, e);
    }
  }
  ...
  public static Object invoke(Object target, String methodName, Object[] args) {
    try {
      ...
      throw new LabelException("couldn't invoke "+methodName+" on "+target, e);
    }
  }
  ...
  public static Field getField(String fieldName, Class<?> clazz) {
    ...
    try {
      ...
      throw new LabelException("not allowed to access field " + field + " on class " + clazz.getCanonicalName());
  ...
  public static void setField(Field field, Object object, Object value) {
    try {
      ...
      throw new LabelException("Could not set field " + field.toString(), e);
  ...
  public static Method getSetter(String fieldName, Class<?> clazz, Class<?> fieldType) {
    ...
    try {
      ...
      throw new LabelException("Not allowed to access method " + setterName + " on class " + clazz.getCanonicalName());
    }
  }
  ...
  public static Object instantiate(String className, Object[] args) {
    ...
    if (constructor==null) {
      throw new LabelException("couldn't find constructor for "+className+" with args "+Arrays.asList(args));
    } 
    try {
      return constructor.newInstance(args);
    } catch (Exception e) {
      throw new LabelException("couldn't find constructor for "+className+" with args "+Arrays.asList(args), e);
    }
  }
