...
import com.winit.svr.delegate.event.ActivitiActivityEvent;
import com.winit.svr.delegate.event.ActivitiEntityEvent;
import com.winit.svr.delegate.event.ActivitiEntityWithVariablesEvent;
import com.winit.svr.delegate.event.ActivitiErrorEvent;
...
import com.winit.svr.delegate.event.ActivitiMembershipEvent;
import com.winit.svr.delegate.event.ActivitiMessageEvent;
import com.winit.svr.delegate.event.ActivitiSequenceFlowTakenEvent;
import com.winit.svr.delegate.event.ActivitiSignalEvent;
	...
	protected static void populateEventWithCurrentContext(ActivitiEventImpl event) {
		...
		if(!extractedFromContext){
			if(event instanceof ActivitiEntityEvent) {
				...
				if(persistendObject instanceof DelegateExecution) {
