...
public class ActivitiEventSupport {
	...
	public synchronized void addEventListener(ActivitiEventListener listenerToAdd) {
		if (listenerToAdd == null) {
			throw new LabelIllegalArgumentException("Listener cannot be null.");
		}
	...
	public void dispatchEvent(ActivitiEvent event) {
		if (event == null) {
			throw new LabelIllegalArgumentException("Event cannot be null.");
		}

		if (event.getType() == null) {
			throw new LabelIllegalArgumentException("Event type cannot be null.");
		}
	...
	protected void dispatchEvent(ActivitiEvent event, ActivitiEventListener listener) {
		try {
			...
			if (listener.isFailOnException()) {
				throw new LabelException("Exception while executing event-listener", t);
			} else {
