...
package com.winit.svr.impl.cfg.jta;
...
public class JtaTransactionContext implements TransactionContext {
  ...
  public void rollback() {
    ...
    try {
      ...
      throw new LabelException("Unexpected IllegalStateException while marking transaction rollback only");
    } catch (SystemException e) {
      throw new LabelException("SystemException while marking transaction rollback only");
    }
  }
  ...
  protected Transaction getTransaction() {
    try {
      ...
      throw new LabelException("SystemException while getting transaction ", e);
    }
  }
  ...
  public void addTransactionListener(TransactionState transactionState, final TransactionListener transactionListener) {
    ...
    try {
      ...
      throw new LabelException("IllegalStateException while registering synchronization ", e);
    } catch (RollbackException e) {
      throw new LabelException("RollbackException while registering synchronization ", e);
    } catch (SystemException e) {
      throw new LabelException("SystemException while registering synchronization ", e);
    }   
  }
