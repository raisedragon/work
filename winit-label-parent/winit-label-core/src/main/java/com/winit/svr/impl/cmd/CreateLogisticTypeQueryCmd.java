 ...
 *
 */
public class CreateLogisticTypeQueryCmd implements Command<LogisticTypeQuery>, Serializable {

  private static final long serialVersionUID = 1L;

  public LogisticTypeQuery execute(CommandContext commandContext) {
    return commandContext
      .getLogisticTypeManager()
      .createNewLogisticTypeQuery();
  }
