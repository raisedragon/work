 ...
 * assigning tasks</li>
 * <li>
 * <b>{@link com.winit.svr.IdentityService}: </b> Used for managing
 * {@link com.winit.svr.identity.User}s, {@link com.winit.svr.identity.Group}s and
 * the relations between them<</li>
 * <li>
 * <b>{@link com.winit.svr.ManagementService}: </b> Exposes engine admin and
 ...
 * {@link LabelServerConfiguration} instance and is a costly operation which should be
 ...
 * @author Joram Barrez
 */
public interface LabelServer extends LabelServerServices {
