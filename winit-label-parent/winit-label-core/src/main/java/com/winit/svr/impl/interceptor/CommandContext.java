...
import com.winit.svr.impl.persistence.entity.LabelEnitityManager;
import com.winit.svr.impl.persistence.entity.LogisticTypeEnitityManager;
...
public class CommandContext {
  ...
  public CommandContext(Command<?> command, LabelServerConfigurationImpl processEngineConfiguration) {
    ...
    this.labelServerConfiguration = processEngineConfiguration;
  ...
  public void close() {
    ...
    if (exception != null) {
      if (exception instanceof Error) {
        ...
        throw new LabelException("exception while executing command " + command, exception);
      }
    }
  }
...
//      }
  ...
  public LogisticTypeEnitityManager getLogisticTypeManager() {
    return getSession(LogisticTypeEnitityManager.class);
  }
  
  public LabelEnitityManager getLabelManager() {
    return getSession(LabelEnitityManager.class);
  }
  ...
  public ActivitiEventDispatcher getEventDispatcher() {
  	return labelServerConfiguration.getEventDispatcher();
  }
}
