...
public class VariableInstanceEntityManager extends AbstractManager {
  ...
  @SuppressWarnings("unchecked")
  public List<VariableInstanceEntity> findLogisticTypeVariableInstancesByLogisticTypeId(String logisticTypeId) {
    return getDbSqlSession().selectList("selectLogisticTypeVariableInstancesByLogisticTypeId", logisticTypeId);
  }
}
