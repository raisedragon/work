 ...
 */
public class LabelIllegalArgumentException extends LabelException {

  private static final long serialVersionUID = 1L;
  
  public LabelIllegalArgumentException(String message) {
    super(message);
  }
  
  public LabelIllegalArgumentException(String message, Throwable cause) {
    super(message, cause);
  }
}
