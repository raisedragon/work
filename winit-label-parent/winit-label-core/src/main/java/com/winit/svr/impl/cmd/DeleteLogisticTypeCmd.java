 ...
 *
 */
public class DeleteLogisticTypeCmd implements Command<Void>, Serializable {

  private static final long serialVersionUID = 1L;
  String logisticTypeId;
  
  public DeleteLogisticTypeCmd(String logisticTypeId) {
  ...
  public Void execute(CommandContext commandContext) {
    ...
    commandContext
      ...
      .deleteLogisticType(logisticTypeId);
