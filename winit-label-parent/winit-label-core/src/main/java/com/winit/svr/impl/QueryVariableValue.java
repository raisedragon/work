  ...
  public void initialize(VariableTypes types) {
    if(variableInstanceEntity == null) {
      ...
      if(type instanceof ByteArrayType) {
        throw new LabelIllegalArgumentException("Variables of type ByteArray cannot be used to query");
      } else if(type instanceof JPAEntityVariableType && operator != QueryOperator.EQUALS) {
        throw new LabelIllegalArgumentException("JPA entity variables can only be used in 'variableValueEquals'");
      } else {
