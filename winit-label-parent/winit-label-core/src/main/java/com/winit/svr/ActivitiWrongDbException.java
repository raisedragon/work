 ...
 * 
 * The check is done when the engine is created in {@link ProcessEngineBuilder#buildLabelServer()}.
 * 
 * @author Tom Baeyens
 */
public class ActivitiWrongDbException extends LabelException {
