...
public class UserQueryImpl extends AbstractQuery<UserQuery, User> implements UserQuery {
  ...
  public UserQuery userFirstName(String firstName) {
    if (firstName == null) {
      throw new LabelIllegalArgumentException("Provided firstName is null");
    }
  ...
  public UserQuery userFirstNameLike(String firstNameLike) {
    if (firstNameLike == null) {
      throw new LabelIllegalArgumentException("Provided firstNameLike is null");
    }
  ...
  public UserQuery userLastName(String lastName) {
    if (lastName == null) {
      throw new LabelIllegalArgumentException("Provided lastName is null");
    }
  ...
  public UserQuery userLastNameLike(String lastNameLike) {
    if (lastNameLike == null) {
      throw new LabelIllegalArgumentException("Provided lastNameLike is null");
    }
  ...
  public UserQuery userFullNameLike(String fullNameLike) {
    if (fullNameLike == null) {
      throw new LabelIllegalArgumentException("Provided full name is null");
    }
  ...
  public UserQuery userEmail(String email) {
    if (email == null) {
      throw new LabelIllegalArgumentException("Provided email is null");
    }
    this.email = email;
    return this;
  }
  ...
  public UserQuery userEmailLike(String emailLike) {
    if (emailLike == null) {
      throw new LabelIllegalArgumentException("Provided emailLike is null");
    }
  ...
  public UserQuery memberOfGroup(String groupId) {
    if (groupId == null) {
      throw new LabelIllegalArgumentException("Provided groupIds is null or empty");
    }
