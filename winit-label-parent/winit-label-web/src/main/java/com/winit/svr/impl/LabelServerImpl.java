...
public class LabelServerImpl implements LabelServer {
  ...
  public LabelServerImpl(LabelServerConfigurationImpl labelServerConfiguration) {
    ...
    commandExecutor.execute(labelServerConfiguration.getSchemaCommandConfig(), new SchemaOperationsProcessEngineBuild());
  ...
  public void close() {
    ...
    commandExecutor.execute(labelServerConfiguration.getSchemaCommandConfig(), new SchemaOperationProcessEngineClose());
