...
import com.winit.svr.impl.interceptor.AbstractCommandInterceptor;
...
public class SpringTransactionInterceptor extends AbstractCommandInterceptor {
  ...
  private int getPropagation(CommandConfig config) {
    switch (config.getTransactionPropagation()) {
      ...
      default:
        throw new LabelIllegalArgumentException("Unsupported transaction propagation: " + config.getTransactionPropagation());
    }
  }
}